...
def speculative_sample(
    ...
    **kwargs,
    ...
    logits_warper=target_model._get_logits_processor(generation_config) if generation_config.do_sample else None
...
if __name__ == "__main__":
    ...
    generation_config = GenerationConfig(
        ...
        max_new_tokens=128,
        _eos_token_tensor=torch.tensor(tokenizer.eos_token_id)
    )
    outputs = speculative_sample(
        input_ids=input_ids,
        target_model=target_model,
